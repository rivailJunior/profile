...
export default function Divider({ text }: { text: string }) {
  return (
    <div className="inline-flex w-full items-center justify-center p-5">
      ...
      <span className="absolute left-1/2 -translate-x-1/2 bg-gray-100 px-3 font-medium capitalize text-brand-pink">
        {text}
      </span>
    </div>
  );
...
export function DividerAboutMe() {
  const t = useTranslations("home");
  return <Divider text={t("about_me")} />;
}
